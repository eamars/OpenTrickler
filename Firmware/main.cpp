...
XNucleoIHM02A1 MotorController(&Motor1Config, &Motor2Config, A4, A5, D4, A2, &_dev_spi);
L6470 *TricklerMotor;
L6470 *ThrowerMotor;
L6470 *CoarseTricklerMotor;
